...
void runDefaultTest(void) {
    ...
    int total_weight3 = 0, total_weight4 = 0; // Total weight moved for tests
    int move_count3 = 0, move_count4 = 0; // Total number of moves for tests
    ...
    printf("First test with 3 disks:\n");
    hanoi(n1, 'A', 'C', 'B', n1, weights3, &total_weight3, &move_count3);
    printf("Total moves: %d\n", move_count3); // Print the total moves
    printf("Total weight moved: %d\n", total_weight3); // Print total weight
    ...
    printf("First test with 3 disks:\n");
    hanoi(n2, 'A', 'C', 'B', n2, weights4, &total_weight4, &move_count4);
    printf("Total moves: %d\n", move_count4); // Print the total moves
    printf("Total weight moved: %d\n", total_weight4); // Print total weight
}
